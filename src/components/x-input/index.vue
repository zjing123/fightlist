...
<script>
import Base from 'vux/src/libs/base'
import weui_access from 'vux/src/styles/weui/widget/weui_cell/weui_access.less';
import weui_cell_global from 'vux/src/styles/weui/widget/weui_cell/weui_cell_global.less';
import weui_form_common from 'vux/src/styles/weui/widget/weui_cell/weui_form/weui_form_common.less';
import weui_vcode from 'vux/src/styles/weui/widget/weui_cell/weui_form/weui_vcode.less';
</script>
<style lang="less">
